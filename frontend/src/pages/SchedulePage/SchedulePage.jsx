...
const SchedulePage = () => {
  ...
  const handleRestoreClick = (appointment, e) => {
    ...
    const updatedAppointments = appointments.map((apt) =>
      apt.id === appointment.id ? { ...apt, status: "Ожидание" } : apt,
    );
    setAppointments(updatedAppointments);
  };
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles.stats}>
            Всего записей:{" "}
            <span className={styles.count}>{appointments.length}</span>
          </div>
        </div>
            ...
            >
              ...
              <div className={styles.confirmModalContent}>
                <p className={styles.confirmModalText}>
                  ...
                  <strong>«{appointmentToConfirm.clientName}»</strong>?
                </p>
                <div className={styles.appointmentDetails}>
                  <div className={styles.detailItem}>
                    <span className={styles.detailLabel}>Услуга:</span>
                    <span className={styles.detailValue}>
                      {appointmentToConfirm.service}
                    </span>
                  </div>
                  <div className={styles.detailItem}>
                    <span className={styles.detailLabel}>Дата и время:</span>
                    <span className={styles.detailValue}>
                      {new Date(appointmentToConfirm.date).toLocaleDateString(
                        "ru-RU",
                      )}{" "}
                      в {appointmentToConfirm.time}
                    </span>
                  </div>
                  <div className={styles.detailItem}>
                    <span className={styles.detailLabel}>Телефон:</span>
                    <span className={styles.detailValue}>
                      {appointmentToConfirm.phone}
                    </span>
                  </div>
                </div>
            ...
            >
              ...
              <div className={styles.cancelModalContent}>
                <p className={styles.cancelModalText}>
                  ...
                  <strong>«{appointmentToCancel.clientName}»</strong>?
                </p>
                <div className={styles.appointmentDetails}>
                  <div className={styles.detailItem}>
                    <span className={styles.detailLabel}>Услуга:</span>
